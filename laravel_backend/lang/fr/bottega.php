...
return [
    ...
    // ── BinocoloService ───────────────────────────────────────────
    'binocolo_error' => 'Erreur lors de l\'analyse Binocolo',
    'binocolo_reason_medium_match' => 'Médium compatible avec le tien',
    'binocolo_reason_medium_any' => 'Ouvert à tous les médiums',
    'binocolo_reason_career_match' => 'Niveau de carrière compatible',
    'binocolo_reason_career_open' => 'Ouvert à tout niveau de carrière',
    'binocolo_reason_deadline_optimal' => 'Échéance optimale pour préparer la candidature',
    'binocolo_reason_deadline_close' => 'Échéance proche — agis maintenant',
    'binocolo_reason_deadline_far' => 'Échéance lointaine — planifie calmement',
    'binocolo_reason_deadline_rolling' => 'Candidatures toujours ouvertes',
    'binocolo_reason_deadline_ok' => 'Échéance à portée',
    'binocolo_reason_country_italy' => 'Opportunité en Italie',
    'binocolo_reason_country_international' => 'Opportunité internationale',

    // ── MarketPulseService ────────────────────────────────────────
    'market_pulse_error' => 'Erreur lors de l\'analyse Market Pulse',
    'market_pulse_no_signals' => 'Aucun signal de marché disponible pour le moment',
    'market_pulse_no_sales' => 'Aucune vente enregistrée — première vente à venir',

    // ── VisibilityTrackerService ──────────────────────────────────
    'visibility_tracker_error' => 'Erreur lors de l\'analyse Visibility Tracker',
    'visibility_no_data' => 'Aucun évènement enregistré dans la période — commencez à partager votre profil',

    // ── BottegaPriceAdvisorService ────────────────────────────────
    'price_advisor_error' => 'Erreur lors de l\'analyse Price Advisor',
    'price_rule_floor' => 'Les prix ne baissent jamais. Si la suggestion est inférieure à l\'actuel, l\'actuel reste.',
    'price_rule_editions' => 'Éditions limitées : Ed.10 = 30-40% original, Ed.25 = 20-30%, Ed.50 = 15-20%.',
    'price_rule_coherence' => 'Œuvres similaires (même medium) avec écart de prix supérieur à 50% signalées comme incohérentes.',

    // ── SestanteService ───────────────────────────────────────────
    'sestante_error' => 'Erreur lors de l\'analyse Sestante',
    'sestante_no_comparables' => 'Trop peu d\'artistes comparables sur FlorenceEGI — au moins 3 nécessaires pour le positionnement',
];
